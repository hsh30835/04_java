...
public class Application03 {
    public static void main(String[] args){
        /*
        * 깊은 복사는 heap에 생성된 배열이 가지고 있는 값 을
        * 또 다른 배열에 복사를 해 놓은 것이다.
        * 서로 같은 값을 가지고 있지만, 두 배열은 서로 다른 배열이기에
        * 하나의 배열에 변겨을 하더라도 다른 배열에는 영햐을 주지 않는다.
        * */
        ...
        * 3. System의 arraycopy()를 이용한복사
        * 4. Array의 copyOf()를 이용한 복사
        * 이중 가장 높은 성능을 보이는 것은 순수 배열의 복사를 위해 만들어진 arraycopy() 메소드 이며
        ...
        * */
        ...
        //orgiainArr = {1,2,3,4,5};
        //copyArr3 = {0,0,0,1,2,3,4,5,0};
