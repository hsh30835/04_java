package main.java.com.ohigiraffers.section05.calendar;
...
public class Applicaiton01 {
    public static void main(String[] args) {
        /*
        * Date 클래스
        * jdak 1.0 부터 날자를 취급하기 위해 사용되던 Date 클래스는
        ...
        *   윤초란?
        *   협정 세계시에서 사용하는 세슘 원자 시계와 실제 지구의 자전/공전 속도를 기준으로 하는 태양시의 차이로 인해
        ...
        * */
        ...
        /* gettime()은 1970년 1월 0시 0분 0초 이후 지난 시간을 millsecond로 계산하여 long타입으로 반환한다. */
        System.out.println(today.getTime());

        Date time = new Date(1698815808472L);
