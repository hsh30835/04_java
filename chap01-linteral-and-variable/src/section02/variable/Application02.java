...
public class Application02 {
    public static void main(String[] args){
        ...
        * */
        ...
        /* 변수에는 자료형이 존재한다.
        *  자료형이란? 다양한 값의 형태로는 어느 정도의 크기를 하나의 값으로 취급할 것인지 미리 Compiler와 약속한 키워드이다.
        * 예) 앞에서 사용한 int 자료형은 정수 40byte 만큼을 읽어서 하나의 값으로 취급하겠다는 약속이다.
        ...
        * 그 중 기본 자료형 8가지를 먼저 확인한다.
        ...
        // 1bite는 0과 1 둘중 하나의 값만을 가질 수 있는 데이터의 최소 단위이다.
        ...
        boolean inTrue; //1byte 논리 데이터 형은 0과 1의 값으로 데이터를 취급하기 때문에 1bit로 표현이 가능하지만
        //최소 단위가 1byte이기 때문에 1byte의 크기를 갖는다.
        ...
        * 그 공간에 대입 연산자를 이용하여 자료형에 저장하기로 한 형태의 값을 지정할 수 있다.
        * 만약, 약속 내용과 다른 형태의 값을 대입하려고 한다면 Compiler는 에러를 발생시킨다.
        *
        * 설명
        * 대입 연산자의 실행 방향은 오른쪽에서 왼쪽이다
        * 즉 오른쪽에 있는 값을 왼쪽의 공간에 대입한다는 의미이며, 왼쪽에는 항상 공간, 오른쪽에는 항상 값이 뜬다.
