...
public class Applicaition1 {
    public static void main(String[] args){
        /*논리 연산자
        * 논리값(true || false)를 취급하는 연산자이다.
        *
        * 논리 연산자의 종류
        * 1. 논리 연결 연산지 : 두 개의 피연산자를 가지는 이항 연산자이며, 연산자의 결함 방향은 왼쪽에서 오른쪽이다.
        * 두개의 논리식을 판단함여 참과 거짓을 판단한다.
        ...
        * 2. 논리 부정 연산자 : 피연산자가 하나의 단항연산자로, 피연산자이 결합 방향은 왼쪽에서 오른족이다.
