...
//        RabbitFarm<Reptile> test = new RabbitFarm<>(); //파충류도 오브젝트를 받아 상관이 없음

        //sueprType(RabbitFarm<? super Bunny>)로 정의가 되어있기 때문에
        //Buuny와 관련이 없는 Reptile 타입을 지시할 수 없게 되는 것이다.

//        wildCardFarm.superType(new RabbitFarm<Reptile>(new Snake())); //Bunny의 조상만 올수있어서 안됨
