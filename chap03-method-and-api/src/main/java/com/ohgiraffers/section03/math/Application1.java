...
public class Application1 {
    public static void main(String[] args){
        ...
        * 코든 코드를 우리가 다 외울수 없기 때문에 api 문서를 별도로 제공해주고 있다.
        * */
        ...
        * (객체의 상태를 관리하지 않고 기능만 제공하는 겨우 메모리를 효율적으로 사용하기 위해 자주 사용되는 기법이다)
        * */
        System.out.println("-7의 절대값 : " + (java.lang.Math.abs(-7)));

        System.out.println("-1.25의 절대값 : " + (Math.abs(-1.25))); //java.lang. 자바에서 기본적으로 제공해줌
        System.out.println("10과 20중 더 작은 것은? " + Math.min(10,20));
        System.out.println("10과 20중 더 큰 것은? : " + Math.max(10,20));

        System.out.println("원주율~: " +Math.PI);
        System.out.println("난수 발생 : " + (int)(Math.random()*10)); //*10은 자리수나타냄
