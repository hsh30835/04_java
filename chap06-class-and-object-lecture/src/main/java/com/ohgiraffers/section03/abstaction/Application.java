...
public class Application {
    public static void main(String[] args){
        ...
        * 따라서 객체를 설계할 때는 속성은 부가적이며 적절한 책임을 가진 객체들간의 주고 받는 메세지를 이용해 상호작용 하는 것을
        * 설계하는 것을 의미한다
        * 즉, 필드보다는 메소드를 중점적으로 추상화 기법을 적용하여 객체를 설계하고, 그 객체를 구현하는 방법으로 설게한 대로 클래스를
        * 작성하는 것이다. 이것은 추상화라고 부른다.
        * */
        ...
        * */
        ...
        loop: while(true){
            ...
            /*if(no == 9){
                break;
            } 여기있는 break는 while문을 종료시킴*/
        }
    }

    /*
    * 추상화란 객체지향 프로그램밍(oop)와 소트프웨어 공학에서 중요한 개념 중 하나이며 추상화는 복잡한 현실세계의 개념, 데이터, 시스템 또는
    * 프로세르를 단순화하거나 요약하여 핵심적인 특징을 강조하고 불필요한 세부 사항을 숨기는 과정이다.
    *
