...
public class Application {
    public static void main(String[] args){
        /*
        * 캡술화의 원칙에는 일부 어긋나긴 하지만 다른 목적을 가진 클래스와 객체를 추상화 하는 기법이 있다.
        * 행위 위주가 아닌 데이터를 하나로 뭉치기 위한 객체(data transfer Object)의 경우이다.
        * 이러한 객체를 설계할 때는 행위가 아닌 데이터가 위주이며, 캡술화의 원칙을 준수하여
        ...
        * 하지만 데이터를 주로 다루는 객체의 겨우 행위를 추상화 하지 않고
        * 미리 모든 필드에 접근 가능성을 염두해도고 작성해두는 관레로 인해 현재도 많이 사용하고 있다.
        *
        * */
